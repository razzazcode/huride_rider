...
import 'package:huride_rider/Models/allUsers.dart';
...
DatabaseReference refrence = FirebaseDatabase.instance.reference().child("users").child(userId);

refrence.once().then((DataSnapshot dataSnapshot)
